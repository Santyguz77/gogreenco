...
// Ruta de prueba
app.get("/", (req, res) => {
  res.send("👗 Servidor de Go Green - Moda Circular funcionando correctamente");
});
...
app.listen(PORT, () => console.log(`✅ API de Go Green - Moda Circular corriendo en puerto ${PORT}`));
